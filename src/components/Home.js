  ...
  return (
    <div>
      ...
      <div style={{ alignItems: "center", justifyContent: "center", display: "flex", paddingTop: "30px" }}>
        ...
        {showRawData && (
          <div style={{ width: "600px", maxHeight: "500px", overflow: "auto", backgroundColor: "grey", color: "#fff", padding: "20px", borderRadius: "10px", alignItems: "center", justifyContent: "center", display: "flex" }}>
           <ul>
